          ...
          > .container {
            ...
            > .svgPix {
              ...
              > svg {
                ...
                padding: 25px;
                border: double 12px ${colors.primary};
                border-radius: 5px;
                max-height: 500px;
                max-width: 600px;
              }
